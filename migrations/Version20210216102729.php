 ...
 */
final class Version20210216102729 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE listings (id INT AUTO_INCREMENT NOT NULL, creation_year DATE NOT NULL, km INT NOT NULL, price INT NOT NULL, description LONGTEXT NOT NULL, title VARCHAR(255) NOT NULL, publish_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
